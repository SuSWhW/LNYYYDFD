...
/*:
 * @target MZ
 * @plugindesc v1.06 Improve the enemy's action routine.
 ...
 * 3. Do not overlay already active states.
 * 4. Do not overlay already limited buffs or debuffs.
 * 5. Do not heal, cure, or revive if there is no valid target.
 * 
 * <Individual Settings>
 ...
 * - Conditions for HP recovery     : <RoutineIfHp:[condition]>.
 ...
 * - Skills that belong to the damage/drain type
...
/*:ja
 * @target MZ
 * @plugindesc v1.06 敵行動ルーチンを改善します。
